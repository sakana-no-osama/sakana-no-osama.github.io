...
TEAM_INPUTS = [
    {
        "tab_id": "team-all",
        "label": "チーム総合",
        "csv": "team_ranking_2026_all.csv",
        "kind": "team",
    },
    {
        "tab_id": "team-div1",
        "label": "チーム1部",
        "csv": "team_ranking_2026_div1.csv",
        "kind": "team",
    },
    {
        "tab_id": "team-div2",
        "label": "チーム2部",
        "csv": "team_ranking_2026_div2.csv",
        "kind": "team",
    },
]
...
<head>
  ...
  <title>2026 関東U-15女子 得点ランキング</title>
  <style>
    :root {{
      --bg: #f6f7f9;
      --card: #ffffff;
...
{sections_html}
    ...
    <footer>
      <p>出典: goal_ranking_2026 / team_ranking_2026 CSV。note列は画面表示せずHTMLコメントに保持。</p>
    </footer>
  </div>
